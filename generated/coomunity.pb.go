...
var file_coomunity_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x06, 0x70, 0x6f, 0x73, 0x74,
	0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x75,
	0x6e, 0x69, 0x74, 0x79, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x52, 0x06, 0x70, 0x6f, 0x73,
	...
	0x64, 0x41, 0x74, 0x22, 0x58, 0x0a, 0x0b, 0x50, 0x6f, 0x73, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x09, 0x63, 0x6f,
...
var file_coomunity_proto_depIdxs = []int32{
	...
	7,  // 1: community.GroupPost.postId:type_name -> community.PostId
	7,  // 2: community.Comment.postId:type_name -> community.PostId
	10, // 3: community.PostComment.commentId:type_name -> community.CommenId
	2,  // 4: community.CommunityService.CreateGroup:input_type -> community.Group
	1,  // 5: community.CommunityService.GetGroup:input_type -> community.GroupId
	2,  // 6: community.CommunityService.UpdateGroup:input_type -> community.Group
	1,  // 7: community.CommunityService.DeleteGroup:input_type -> community.GroupId
	0,  // 8: community.CommunityService.GetAllGroups:input_type -> community.Req
	5,  // 9: community.CommunityService.JoinGroupUser:input_type -> community.JoinLeave
	5,  // 10: community.CommunityService.LeaveGroupUser:input_type -> community.JoinLeave
	6,  // 11: community.CommunityService.UpdateGroupMeber:input_type -> community.UserRole
	8,  // 12: community.CommunityService.CreatePost:input_type -> community.Post
	8,  // 13: community.CommunityService.UpdatePost:input_type -> community.Post
	7,  // 14: community.CommunityService.DeletePost:input_type -> community.PostId
	7,  // 15: community.CommunityService.GetPost:input_type -> community.PostId
	9,  // 16: community.CommunityService.GetGroupPost:input_type -> community.GroupPost
	11, // 17: community.CommunityService.CreatePostComments:input_type -> community.Comment
	12, // 18: community.CommunityService.GetPostComments:input_type -> community.PostComment
	3,  // 19: community.CommunityService.CreateGroup:output_type -> community.Status
	2,  // 20: community.CommunityService.GetGroup:output_type -> community.Group
	3,  // 21: community.CommunityService.UpdateGroup:output_type -> community.Status
	3,  // 22: community.CommunityService.DeleteGroup:output_type -> community.Status
	4,  // 23: community.CommunityService.GetAllGroups:output_type -> community.Groups
	3,  // 24: community.CommunityService.JoinGroupUser:output_type -> community.Status
	3,  // 25: community.CommunityService.LeaveGroupUser:output_type -> community.Status
	3,  // 26: community.CommunityService.UpdateGroupMeber:output_type -> community.Status
	3,  // 27: community.CommunityService.CreatePost:output_type -> community.Status
	3,  // 28: community.CommunityService.UpdatePost:output_type -> community.Status
	3,  // 29: community.CommunityService.DeletePost:output_type -> community.Status
	8,  // 30: community.CommunityService.GetPost:output_type -> community.Post
	8,  // 31: community.CommunityService.GetGroupPost:output_type -> community.Post
	3,  // 32: community.CommunityService.CreatePostComments:output_type -> community.Status
	11, // 33: community.CommunityService.GetPostComments:output_type -> community.Comment
